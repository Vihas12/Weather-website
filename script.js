// let apikey = '0703127a299c462b990153039242306';
// //http://api.weatherapi.com/v1/current.json?key=0703127a299c462b990153039242306&q=London&aqi=yes

// const city = document.getElementById('search')
// const srcbtn = document.getElementById('srcbtn')

// async function getData(apikey,city) {
//     const promise = await fetch('http://api.weatherapi.com/v1/current.json?key=${apikey}&q=${city}&aqi=yes');
//     return await promise.json();
// }

// srcbtn.addEventListener('click',async()=>{
//     const input = city.ariaValueMax;
